...
from cannabis.consensus.network_type import NetworkType
from cannabis.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from cannabis.farmer.farmer import Farmer
from cannabis.protocols import farmer_protocol, harvester_protocol
from cannabis.protocols.harvester_protocol import PoolDifficulty
...
from cannabis.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSCannabisConnection
    ):
        """
        ...
        for sp in sps:
            ...
            # If the iters are good enough to make a block, proceed with the block making cannabis
