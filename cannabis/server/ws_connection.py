...
from cannabis.cmds.init_funcs import cannabis_full_version_str
from cannabis.protocols.protocol_message_types import ProtocolMessageTypes
from cannabis.protocols.shared_protocol import Capability, Handshake
from cannabis.server.outbound_message import Message, NodeType, make_msg
from cannabis.server.rate_limits import RateLimiter
...
from cannabis.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from cannabis.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSCannabisConnection:
    """
