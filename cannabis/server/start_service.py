...
from cannabis.daemon.server import singleton, service_launch_lock_path
from cannabis.server.ssl_context import cannabis_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"cannabis_{service_name}"
        ...
        cannabis_ca_crt, cannabis_ca_key = cannabis_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = CannabisServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (cannabis_ca_crt, cannabis_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for CannabisServer to be closed")
