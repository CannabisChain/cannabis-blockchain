...
from cannabis.cmds.configure import configure_cmd
from cannabis.cmds.farm import farm_cmd
from cannabis.cmds.init import init_cmd
from cannabis.cmds.keys import keys_cmd
from cannabis.cmds.netspace import netspace_cmd
from cannabis.cmds.plots import plots_cmd
from cannabis.cmds.show import show_cmd
from cannabis.cmds.start import start_cmd
from cannabis.cmds.stop import stop_cmd
from cannabis.cmds.wallet import wallet_cmd
from cannabis.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage cannabis blockchain infrastructure ({__version__})\n",
    epilog="Try 'cannabis start node', 'cannabis netspace -d 192', or 'cannabis show -s'",
...
@cli.command("version", short_help="Show cannabis version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs cannabis daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from cannabis.daemon.server import async_run_daemon
    import asyncio
