...
from cannabis.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic
from cannabis.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run cannabis keys add")
    return mnemonic
