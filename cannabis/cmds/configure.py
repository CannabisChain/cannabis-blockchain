...
from cannabis.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "55444"
            testnet_introducer = "beta1_introducer.cannabischain.net"
            testnet = "testnet7"
            ...
            mainnet_port = "5444"
            mainnet_introducer = "introducer.cannabischain.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running cannabis services for changes to take effect")
