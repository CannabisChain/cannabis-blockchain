...
from cannabis.types.blockchain_format.program import Program, INFINITE_COST
from cannabis.types.condition_opcodes import ConditionOpcode
from cannabis.types.spend_bundle import SpendBundle
from cannabis.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "cannabis" in cc_discrepancies:
                    cc_discrepancies["cannabis"] = cc_discrepancies["cannabis"] + diff
                else:
                    cc_discrepancies["cannabis"] = diff
