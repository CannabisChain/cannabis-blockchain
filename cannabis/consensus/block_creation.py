...
from cannabis.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
...
from cannabis.util.prev_transaction_block import get_prev_transaction_block
from cannabis.util.recursive_replace import recursive_replace
