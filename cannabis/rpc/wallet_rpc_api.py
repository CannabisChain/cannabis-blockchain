...
from cannabis.cmds.init_funcs import check_keys
from cannabis.consensus.block_rewards import calculate_base_farmer_reward
from cannabis.pools.pool_wallet import PoolWallet
from cannabis.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from cannabis.protocols.protocol_message_types import ProtocolMessageTypes
from cannabis.server.outbound_message import NodeType, make_msg
from cannabis.simulator.simulator_protocol import FarmNewBlockProtocol
...
from cannabis.util.keychain import bytes_to_mnemonic, generate_mnemonic
from cannabis.util.path import path_from_root
from cannabis.util.ws_message import WsRpcMessage, create_payload_dict
from cannabis.wallet.cc_wallet.cc_wallet import CCWallet
from cannabis.wallet.derive_keys import master_sk_to_singleton_owner_sk
from cannabis.wallet.rl_wallet.rl_wallet import RLWallet
from cannabis.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk
...
from cannabis.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from cannabis.wallet.util.trade_utils import trade_record_to_dict
...
from cannabis.wallet.wallet_info import WalletInfo
from cannabis.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "cannabis_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "cannabis_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from cannabis.pools.pool_wallet_info import initial_pool_state_from_dict
