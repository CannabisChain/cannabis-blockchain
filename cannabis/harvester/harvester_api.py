...
from cannabis.harvester.harvester import Harvester
from cannabis.plotting.plot_tools import PlotInfo, parse_plot_info
from cannabis.protocols import harvester_protocol
from cannabis.protocols.farmer_protocol import FarmingInfo
from cannabis.protocols.harvester_protocol import Plot
from cannabis.protocols.protocol_message_types import ProtocolMessageTypes
from cannabis.server.outbound_message import make_msg
...
from cannabis.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSCannabisConnection
    ):
        """
